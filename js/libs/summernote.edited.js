(function(factory) {
	...
	var button = renderer.create('<button type="button" class="note-btn btn btn-default btn-sm">', function() {});
	...
	var ImageDialog = function(context) {
		...
		this.initialize = function() {
			...
			var body = '<div class="form-group note-group-select-from-files">' +
				...
				'<input class="note-image-input form-control" type="file" name="files" accept="image/*" multiple="multiple" placeholder="哈哈" />' +
				imageLimitation +
				'</div>';
